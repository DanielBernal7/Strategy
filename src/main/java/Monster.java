...
//    System.out.println("hp=" + hp + "/" + maxHP);
  ...
  public boolean equals(Object o) {
    ...
    if (getHp() != null ? !getHp().equals(monster.getHp()) : monster.getHp() != null) {
      return false;
    }
    if (getXp() != null ? !getXp().equals(monster.getXp()) : monster.getXp() != null) {
      return false;
    }
    if (getMaxHP() != null ? !getMaxHP().equals(monster.getMaxHP()) : monster.getMaxHP() != null) {
      return false;
    }
